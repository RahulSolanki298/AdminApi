...
namespace AdminApi.Migrations
{
    ...
    [Migration("20221001055658_school")]
            ...
            modelBuilder.Entity("AdminApi.Models.Menu.AppMenu", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            MenuID = 1,
                            AddedBy = 1,
                            DateAdded = new DateTime(2022, 10, 1, 11, 26, 58, 41, DateTimeKind.Local).AddTicks(9180),
                        ...
                        new
                        {
                            MenuID = 2,
                            AddedBy = 1,
                            DateAdded = new DateTime(2022, 10, 1, 11, 26, 58, 41, DateTimeKind.Local).AddTicks(9183),
                        ...
                        new
                        {
                            MenuID = 3,
                            AddedBy = 1,
                            DateAdded = new DateTime(2022, 10, 1, 11, 26, 58, 41, DateTimeKind.Local).AddTicks(9185),
                            IconClass = "",
                            IsActive = true,
                            IsMigrationData = true,
                            IsSubMenu = 0,
                        ...
                        new
                        {
                            MenuID = 4,
                            AddedBy = 1,
                            DateAdded = new DateTime(2022, 10, 1, 11, 26, 58, 41, DateTimeKind.Local).AddTicks(9186),
                            IconClass = "",
                            IsActive = true,
                            IsMigrationData = true,
                            IsSubMenu = 0,
                        ...
                        new
                        {
                            MenuID = 5,
                            AddedBy = 1,
                            DateAdded = new DateTime(2022, 10, 1, 11, 26, 58, 41, DateTimeKind.Local).AddTicks(9187),
                        ...
                        new
                        {
                            MenuID = 6,
                            AddedBy = 1,
                            DateAdded = new DateTime(2022, 10, 1, 11, 26, 58, 41, DateTimeKind.Local).AddTicks(9188),
                            IconClass = "",
                            IsActive = true,
                            IsMigrationData = true,
                            IsSubMenu = 0,
                        ...
                        new
                        {
                            MenuID = 7,
                            AddedBy = 1,
                            DateAdded = new DateTime(2022, 10, 1, 11, 26, 58, 41, DateTimeKind.Local).AddTicks(9190),
                            IconClass = "",
                            IsActive = true,
                            IsMigrationData = true,
                            IsSubMenu = 0,
                        ...
                        new
                        {
                            MenuID = 8,
                            AddedBy = 1,
                            DateAdded = new DateTime(2022, 10, 1, 11, 26, 58, 41, DateTimeKind.Local).AddTicks(9191),
                            IconClass = "",
                            IsActive = true,
                            IsMigrationData = true,
                            IsSubMenu = 0,
                        ...
                        new
                        {
                            MenuID = 9,
                            AddedBy = 1,
                            DateAdded = new DateTime(2022, 10, 1, 11, 26, 58, 41, DateTimeKind.Local).AddTicks(9193),
                        ...
                        new
                        {
                            MenuID = 10,
                            AddedBy = 1,
                            DateAdded = new DateTime(2022, 10, 1, 11, 26, 58, 41, DateTimeKind.Local).AddTicks(9194),
                            IconClass = "",
                            IsActive = true,
                            IsMigrationData = true,
                            IsSubMenu = 0,
            ...
            modelBuilder.Entity("AdminApi.Models.Menu.MenuGroup", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            MenuGroupID = 1,
                            AddedBy = 1,
                            DateAdded = new DateTime(2022, 10, 1, 11, 26, 58, 41, DateTimeKind.Local).AddTicks(7479),
                            IsActive = true,
                            IsMigrationData = true,
                        ...
                        new
                        {
                            MenuGroupID = 2,
                            AddedBy = 1,
                            DateAdded = new DateTime(2022, 10, 1, 11, 26, 58, 41, DateTimeKind.Local).AddTicks(7490),
                            IsActive = true,
                            IsMigrationData = true,
            ...
            modelBuilder.Entity("AdminApi.Models.Menu.MenuGroupWiseMenuMapping", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AddedBy = 1,
                            DateAdded = new DateTime(2022, 10, 1, 11, 26, 58, 41, DateTimeKind.Local).AddTicks(9580),
                            IsActive = true,
                            IsMigrationData = true,
                            MenuGroupId = 1,
                            MenuId = 1
                        ...
                        new
                        {
                            ...
                            AddedBy = 1,
                            DateAdded = new DateTime(2022, 10, 1, 11, 26, 58, 41, DateTimeKind.Local).AddTicks(9583),
                            IsActive = true,
                            IsMigrationData = true,
                            MenuGroupId = 1,
                            MenuId = 3
                        ...
                        new
                        {
                            ...
                            AddedBy = 1,
                            DateAdded = new DateTime(2022, 10, 1, 11, 26, 58, 41, DateTimeKind.Local).AddTicks(9584),
                            IsActive = true,
                            IsMigrationData = true,
                            MenuGroupId = 1,
                            MenuId = 4
                        ...
                        new
                        {
                            ...
                            AddedBy = 1,
                            DateAdded = new DateTime(2022, 10, 1, 11, 26, 58, 41, DateTimeKind.Local).AddTicks(9585),
                            IsActive = true,
                            IsMigrationData = true,
                            MenuGroupId = 1,
                            MenuId = 6
                        ...
                        new
                        {
                            ...
                            AddedBy = 1,
                            DateAdded = new DateTime(2022, 10, 1, 11, 26, 58, 41, DateTimeKind.Local).AddTicks(9586),
                            IsActive = true,
                            IsMigrationData = true,
                            MenuGroupId = 1,
                            MenuId = 7
                        ...
                        new
                        {
                            ...
                            AddedBy = 1,
                            DateAdded = new DateTime(2022, 10, 1, 11, 26, 58, 41, DateTimeKind.Local).AddTicks(9587),
                            IsActive = true,
                            IsMigrationData = true,
                            MenuGroupId = 1,
                            MenuId = 10
                        ...
                        new
                        {
                            ...
                            AddedBy = 1,
                            DateAdded = new DateTime(2022, 10, 1, 11, 26, 58, 41, DateTimeKind.Local).AddTicks(9588),
                            IsActive = true,
                            IsMigrationData = true,
                            MenuGroupId = 2,
                            MenuId = 1
                        ...
                        new
                        {
                            ...
                            AddedBy = 1,
                            DateAdded = new DateTime(2022, 10, 1, 11, 26, 58, 41, DateTimeKind.Local).AddTicks(9589),
                            IsActive = true,
                            IsMigrationData = true,
                            MenuGroupId = 2,
                            MenuId = 8
                        ...
                        new
                        {
                            ...
                            AddedBy = 1,
                            DateAdded = new DateTime(2022, 10, 1, 11, 26, 58, 41, DateTimeKind.Local).AddTicks(9590),
                            IsActive = true,
                            IsMigrationData = true,
                            MenuGroupId = 2,
                            MenuId = 10
            ...
            modelBuilder.Entity("AdminApi.Models.User.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserRoleId = 1,
                            AddedBy = 1,
                            DateAdded = new DateTime(2022, 10, 1, 11, 26, 58, 41, DateTimeKind.Local).AddTicks(7993),
                            IsActive = true,
                            IsMigrationData = true,
                            MenuGroupId = 1,
                            RoleName = "Admin"
                        ...
                        new
                        {
                            UserRoleId = 2,
                            AddedBy = 1,
                            DateAdded = new DateTime(2022, 10, 1, 11, 26, 58, 41, DateTimeKind.Local).AddTicks(7996),
                            IsActive = true,
                            IsMigrationData = true,
                            MenuGroupId = 2,
                            RoleName = "User"
            ...
            modelBuilder.Entity("AdminApi.Models.User.Users", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AddedBy = 1,
                            CityId = 0,
                            DateAdded = new DateTime(2022, 10, 1, 11, 26, 58, 41, DateTimeKind.Local).AddTicks(8615),
                            FirstName = "John",
                            IsActive = true,
                            IsMigrationData = true,
                        ...
                        new
                        {
                            ...
                            AddedBy = 1,
                            CityId = 0,
                            DateAdded = new DateTime(2022, 10, 1, 11, 26, 58, 41, DateTimeKind.Local).AddTicks(8618),
                            FirstName = "Helen",
                            IsActive = true,
                            IsMigrationData = true,
                            IsPasswordChange = false,
